...
<html>
    ...
    <script src="${pageContext.request.contextPath}/resources/js/controller/formExpor_controller.js" type="text/javascript"></script>
    ...
    <body ng-app="formularioExp" >
        ...
        <div class="generic-container" ng-controller="exportacion" class="form-group" style="width: 300px;text-align: center;margin: 0 auto;">
            ...
            <form ng-submit="guardar()" name="FormExportacion">  
                <input type="hidden" ng-model="" />

                <p>Origen: <input type="text" ng-model="origen"  class="form-control"></p> 

                <p>Instancias: <input type="text" ng-model="" class="form-control"></p> 

                <p>Observaciones: <input type="text" ng-model="" class="form-control"></p> 

                <p>Fecha: <input type="date" ng-model="" class="form-control"></p>
